...
<template>
  ...
  >
      ...
      <div class="row">
        <div class="col-lg-12 text-center zindex-1">
          ...
          <img
            ...
            src="../../assets/images/hero-area/banner-img.png"
            alt="banner-img"
          />
        </div>
      </div>
    ...
    <div id="scene">
      <img
        ...
        src="../../assets/images/background-shape/feature-bg-2.png"
        alt=""
      />
      <img
        class="img-fluid hero-bg-2 left-right-animation"
        src="../../assets/images/background-shape/seo-ball-1.png"
        alt=""
      />
      <img
        class="img-fluid hero-bg-3 left-right-animation"
        src="../../assets/images/background-shape/seo-half-cycle.png"
        alt=""
      />
      <img
        class="img-fluid hero-bg-4 up-down-animation"
        src="../../assets/images/background-shape/green-dot.png"
        alt=""
      />
      <img
        class="img-fluid hero-bg-5 left-right-animation"
        src="../../assets/images/background-shape/blue-half-cycle.png"
        alt=""
      />
      <img
      ...
      <img
        ...
        src="../../assets/images/background-shape/yellow-triangle.png"
        alt=""
      />
      <img
        class="img-fluid hero-bg-8 up-down-animation"
        src="../../assets/images/background-shape/service-half-cycle.png"
        alt=""
      />
      <img
        class="img-fluid hero-bg-9 up-down-animation"
        src="../../assets/images/background-shape/team-bg-triangle.png"
        alt=""
      />
    </div>
  </section>
  ...
  <section class="section feature mb-0" id="feature">
    ...
    <img
      ...
      src="../../assets/images/background-shape/feature-bg-1.png"
      alt="bg-shape"
    />
    <img
  ...
  <section class="section-lg seo">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="seo-image">
            <img
              class="img-fluid"
              src="../../assets/images/marketing/marketing.png"
              alt="form-img"
            />
          </div>
        </div>
    ...
    <img
      ...
      src="../../assets/images/backgrounds/seo-bg.png"
      alt="seo-bg"
    />
    <!-- background-shape -->
    <img
    ...
    <img
      ...
      src="../../assets/images/background-shape/seo-ball-2.png"
      alt="bg-shape"
    />
  </section>
  <!-- /marketing -->
  ...
  <section class="section-lg service">
      ...
      <div class="row justify-content-between">
        <div class="col-md-5 order-2 order-md-1">
          ...
          <ul class="pl-0 service-list">
            <li>
              <i class="ti-layout-tab-window text-purple"></i>Responsive on any
              device
            </li>
            <li>
              <i class="ti-layout-placeholder text-purple"></i>Very easy to
              customize
            </li>
    ...
    <img
      ...
      src="../../assets/images/backgrounds/service-bg.png"
      alt="service-bg"
    />
    <!-- background shapes -->
    <img
  ...
  <section class="section-lg team" id="team">
    ...
    <!-- backgound image -->
    <img
      src="../../assets/images/backgrounds/team-bg.png"
      alt="team-bg"
    ...
    <img
      ...
      src="../../assets/images/background-shape/team-bg-dots.png"
      alt="background-shape"
    />
  </section>
  <!-- /team -->
      ...
      <div class="client-logo-slider align-self-center">
        <a href="#" class="text-center d-block outline-0 p-5"
          ><img
            ...
            src="../../assets/images/clients-logo/client-logo-1.png"
            alt="client-logo"
        /></a>
        <a href="#" class="text-center d-block outline-0 p-5"
          ><img
            class="d-unset img-fluid"
            src="../../assets/images/clients-logo/client-logo-2.png"
            alt="client-logo"
        /></a>
        <a href="#" class="text-center d-block outline-0 p-5"
          ><img
            class="d-unset img-fluid"
            src="../../assets/images/clients-logo/client-logo-3.png"
            alt="client-logo"
        /></a>
        <a href="#" class="text-center d-block outline-0 p-5"
          ><img
            class="d-unset img-fluid"
            src="../../assets/images/clients-logo/client-logo-4.png"
            alt="client-logo"
        /></a>
        <a href="#" class="text-center d-block outline-0 p-5"
          ><img
            class="d-unset img-fluid"
            src="../../assets/images/clients-logo/client-logo-5.png"
            alt="client-logo"
        /></a>
        <a href="#" class="text-center d-block outline-0 p-5"
          ><img
